...
//            this.reply(m.chat, `? Sudah waktunya *${this.user.name}* untuk meninggalkan grup\n? Jangan lupa sewa lagi ya!`, null).then(() => {
            this.reply(m.chat, `? Sudah waktunya KiBOT untuk meninggalkan grup\n? Jangan lupa sewa lagi ya di owner kami ${global.nomorown}`, null).then(() => {
