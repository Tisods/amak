...
const defaultMenu = {
  before: `┏━>〔 *llı INFO BOT ıll* 〕
┃• *Bot Name:* %me
┃• *Mode:* Public
┃• *Platform:* Linux
┃• *Type:* Node.Js, Python, Pascal 
...
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    const ultah = new Date('March 22 2023 17:59:59')
...
// 	text.trim(), `${wish()} ${name}\n\nstatus.kibot.my.id © KiroFyzu`, `${flaa}`, [
//        [`ꜱᴇᴡᴀʙᴏᴛ`, `${usedPrefix}sewa`],
//       [`۪۪ᴀᴜᴛʜᴏʀ ʙᴏᴛ`, `${usedPrefix}owner`],
//       [`\nKIBOT KEREN BANGET`, `${usedPrefix}pujiro`]
//    ], m, {
// contextInfo: { externalAdReply :{ showAdAttribution: true,
//                         sourceUrl: sgc,
//                         mediaType: 2,
//                         description: `Kiro Fyzu`,
//                         title: `Ramadhan: ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik Lagi`,
