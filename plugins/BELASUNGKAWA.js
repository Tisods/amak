let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    await conn.sendButton(m.chat, `*Kami seluruh Tim Kiro BOT turut berduka atas kepergian Almarhum/Almarhuma*\n\n“${pickRandom(global.belasungkawa)}”`, '© Turut Berduka', url, [['Thanks Bro', '.thanks']], m)
}
handler.command = /^(belasungkawa|turutberduka)$/i
handler.tags = ['quotes']
handler.help = ['belasungkawa', 'turutberduka']
handler.limit = true
...
global.belasungkawa = [
    "Turut berduka cita atas meninggalnya ayah/ibu/sahabat.",
    "Terimalah belasungkawa tulus kami. Kami memikirkannya.",
    "Aku sangat sedih mendengar kehilanganya. Aku turut berbelasungkawa.",
    "Turut berduka cita yang sedalam-dalamnya atas kehilangan nya",
    "Semoga Allah (SWT) memberinya puncak tertinggi Jannah dan mengampuni dosa-dosanya. Aku turut berbelasungkawa.",
    "Inna Lillahi Wa Inna Ilaihi Rajiun. Semoga Allah memberikan Jannatul Firdaus dan mengampuni dosa-dosanya.",
    "Nasib kamu sudah tertulis sejak lahir. Jadi, mengapa kehilangan harapan? Allah ada untukmu. Coba ingat dia dalam situasi buruk ini, Dia akan selalu mengingatmu."
]
global.gamanaufal = [
